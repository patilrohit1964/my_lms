    ...
    return (
        ...
        <div className='relative bg-gradient-to-l from-blue-500 to bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center'>
            <div className='max-w-3xl mx-auto'>
                ...
                <form className='mb-8 flex justify-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max-w-xl mx-auto'>
                    <input
                        type="text"
                    ...
                    />
                    <Button className="bg-blue-500 dark:bg-gray-700 text-white px-6 py-3 rounded-r-full hover:bg-blue-700 dark:hover::bg-blue-800 h-12">Search</Button>
                </form>
